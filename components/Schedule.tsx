...
const scheduleData: Record<number, Event[]> = {
  1: [
    {
      ...
      category: "Tech",
      time: "11:30 PM",
      venue: "All Labs (B2 - Ground Floor)",
  ...
  2: [
    ...
    },
    {
      title: "Robo “दौड़”",
      category: "Robotics",
      time: "12:30 PM (Univ) | 02:00 PM (School)",
      venue: "Volleyball Court",
    ...
    },
    {
      title: "Robo Football",
      category: "Robotics",
      time: "02:30 PM (Univ) | 02:00 PM (School)",
      venue: "Volleyball Court",
      description: "Autonomous robots compete in a football challenge.",
      colSpan: 2,
      rowSpan: 1,
    },
    {
      title: "Drone Race",
      category: "Robotics",
      time: "01:30 PM (Univ) | 03:30 PM (School)",
      venue: "Admin Ground",
  ...
  3: [
    ...
    },
    {
      ...
      time: "TBA",
      venue: "Admin Mini Auditorium",
      description: "Gear up for the ultimate gaming showdown with BGMI Battle Royale",
      colSpan: 2,
      rowSpan: 1,
    },
  ],
