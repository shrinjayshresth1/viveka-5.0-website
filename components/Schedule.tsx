...
type Event = {
  title: string;
  category: "Tech" | "Robotics" | "Fun" | "Workshop";
  time: string;
  venue: string;
  description: string;
  colSpan: 1 | 2;
  ...
  1: [
    {
      ...
      description: "Inauguration by Prof. H.C. Verma.",
      colSpan: 2,
      rowSpan: 1,
    },
    {
      title: "Code Wars (Round 1)",
      category: "Tech",
      time: "11:00 AM",
      venue: "Computer Lab 1",
      description: "The battle begins. Algorithmic challenges.",
      colSpan: 1,
      rowSpan: 1,
    },
    {
      ...
      description: "Manual bots face off in the arena.",
      colSpan: 1,
      rowSpan: 2,
    },
    {
      ...
      time: "02:00 PM",
      venue: "Seminar Hall",
      description: "Hands-on GenAI session with experts.",
      colSpan: 2,
      rowSpan: 1,
    },
  ],
  2: [
    {
      ...
      description: "Build the future. Non-stop coding.",
      colSpan: 2,
      rowSpan: 2,
    },
    {
      ...
      time: "10:00 AM",
      venue: "Corridor A",
      description: "Autonomous bot race against time.",
      colSpan: 1,
      rowSpan: 1,
    },
    {
      title: "Gaming: Valorant",
      category: "Fun",
      time: "11:00 AM",
    ...
    },
    {
      ...
      time: "03:00 PM",
      venue: "Auditorium",
      description: "Test your geek knowledge.",
      colSpan: 2,
      rowSpan: 1,
    },
  ],
  3: [
    {
      ...
      description: "Showcase of top innovation projects.",
      colSpan: 2,
      rowSpan: 1,
    },
    {
    ...
    },
    {
      ...
      time: "05:00 PM",
      venue: "Main Ground",
      description: "Music, Dance, and DJ Night.",
      colSpan: 1,
      rowSpan: 1,
    },
    {
      ...
      time: "04:00 PM",
      venue: "Main Stage",
      description: "Awarding the champions of Viveka 5.0.",
      colSpan: 2,
      rowSpan: 1,
    },
  ],
